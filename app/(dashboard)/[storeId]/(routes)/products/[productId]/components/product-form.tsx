...
import ReactSelectUI from "@/components/ui/react-select";
...
const formSchema = z.object({
  ...
  perDiscount: z.coerce.number().min(0),
});
...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  useEffect(() => {
    if (initialData && initialData.isDiscounted) {
      setIsDiscounted(initialData.isDiscounted);
    }
  }, [initialData]);
  ...
  const defaultValues = initialData
    ? {
        ...
        priceVN: parseFloat(String(initialData?.priceVN)),
        perDiscount: parseInt(String(initialData?.perDiscount)),
        sizeIds: initialData.sizes.map((size: any) => size.size.id),
        colorIds: initialData.colors.map((color: any) => color.color.id),
      }
    : {
        name: "",
        images: [],
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      This product will appear as Discount on the home page
                    </FormDescription>
                  </div>
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel>Newed</FormLabel>
                    <FormDescription>
                      This product will appear as New on the home page
                    </FormDescription>
                  </div>
                </FormItem>
              )}
